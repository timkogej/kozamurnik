...
export default function KontaktPage() {
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[5fr_7fr] gap-12 lg:gap-16">
            ...
            <div className="space-y-8">
              ...
              <a
                ...
                className="flex items-center gap-4 p-6 bg-brand-500 hover:bg-brand-600 rounded-2xl transition-colors group"
              >
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={label}
                    className="flex items-center gap-4 p-4 bg-ink-800 border border-ink-700 rounded-xl"
                  >
                    <div className="w-10 h-10 rounded-lg bg-brand-500/10 flex items-center justify-center shrink-0">
                      <Icon className="w-5 h-5 text-brand-500" aria-hidden />
                    </div>
                    <div>
                      <p className="text-xs text-fog-500 mb-0.5">{label}</p>
                      <a
                        href={href}
                        className="text-sm font-medium text-fog-200 hover:text-fog-50 transition-colors"
                      >
                        {value}
                      </a>
                    </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-ink-800 border border-ink-700 rounded-xl">
                  ...
                  <div>
                    <p className="text-xs text-fog-500 mb-0.5">Naslov</p>
                    <p className="text-sm font-medium text-fog-200">{siteConfig.address.full}</p>
                    <a
                      href={siteConfig.externalLinks.maps}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1 mt-1.5 text-xs text-brand-500 hover:text-brand-400"
                    >
                ...
                <div className="flex items-start gap-4 p-4 bg-ink-800 border border-ink-700 rounded-xl">
                  ...
                  <div>
                    <p className="text-xs text-fog-500 mb-1.5">Delovni čas</p>
                    <p className="text-sm text-fog-300">{siteConfig.hours.weekdays}</p>
                    <p className="text-xs text-fog-500">{siteConfig.hours.weekdaysNote}</p>
                    <p className="text-sm text-fog-300 mt-1">{siteConfig.hours.saturday}</p>
                    <p className="text-sm text-fog-500">{siteConfig.hours.sunday}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  aria-label="Facebook"
                  className="p-3 rounded-xl bg-ink-800 border border-ink-700 hover:border-brand-500/40 transition-colors"
                >
                  <Share2 className="w-5 h-5 text-fog-500" aria-hidden />
                </a>
                <a
                  ...
                  className="p-3 rounded-xl bg-ink-800 border border-ink-700 hover:border-brand-500/40 transition-colors"
                >
                  <AtSign className="w-5 h-5 text-fog-500" aria-hidden />
                </a>
              </div>
            </div>
            ...
            <div>
              <div className="bg-ink-800 border border-ink-700 rounded-2xl p-6 md:p-8">
                <h2 className="font-display font-semibold text-2xl text-fog-50 mb-2">
                  Pošljite sporočilo
                </h2>
      ...
      {/* Maps — DARK */}
      <section className="bg-ink-950 py-12 border-t border-ink-700">
        <Container>
          ...
          <div className="mt-4 text-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 text-sm text-fog-400 hover:text-fog-50 transition-colors"
            >
